...
++FLAGS = $(CCFLAGS) -std=c++1y -fno-threadsafe-statics -fno-rtti -fno-exceptions -fno-use-cxa-atexit -fno-unwind-tables -ffunction-sections -fdata-sections -Wl,--gc-sections
...
COBJ = cppstubs.o init.o locks.o producer.o context.o kernel.o
